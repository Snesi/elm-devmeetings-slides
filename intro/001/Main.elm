...
-- Elm es un lenguaje de programación funcional 
-- creado por un chico llamado Evan Czaplicki
elmCreator = "Evan Czaplicki"

-- Se creó con la intención de fusionar la usabilidad y 
-- accesibilidad de JS con la mantenibilidad de lenguajes 
-- funcionales como Haskell
